// Bản dịch tĩnh cho 5 ngôn ngữ: Đài Loan (zh-TW), Nhật (ja), Pháp (fr), Ý (it), Hàn (ko)
...
const translations: Translations = {
    ...
    ko: {
        ...
        'Please enter a valid business email.': '유효한 비즈니스 이메일을 입력해 주세요.',
        'Please enter your Page Name.': '페이지 이름을 입력해 주세요.',
        'Please describe your issue': '문제를 설명해 주세요',
